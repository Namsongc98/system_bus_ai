---
description: Guide Claude to implement a backend feature in this Java Spring Boot project.
...
Use this prompt to guide Claude when implementing a backend feature.
...
- Read `ticket-system/CLAUDE.md` first.
