...
2. Read `.codex/references/frontend/api-json-service.md` for normal JSON endpoint examples.
3. Read `.codex/references/frontend/api-document.md` only when endpoint details must come from the project API docs.
