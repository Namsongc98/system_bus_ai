...
5. Read `.codex/references/frontend/rules/api-service-rules.md` and `.codex/references/frontend/api-error-handling.md` when API behavior is involved.
6. Compare request and response handling against `.codex/references/frontend/api-document.md` when needed.
