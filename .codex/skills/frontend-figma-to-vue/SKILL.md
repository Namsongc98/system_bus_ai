...
1. Read `.codex/references/frontend/frontend-instructions.md` for project architecture rules.
2. Read `.codex/references/frontend/rules/figma-style-rules.md` when exact visual conversion or style mapping is needed.
3. Read `.codex/references/frontend/rules/clean-code.md` and `.codex/references/frontend/rules/rule-component.md` for coding rules and component creation / update rules.
4. Read `.codex/references/frontend/component-registry.md` before replacing or creating UI components.
5. For full page composition, read `.codex/references/frontend/page-integration-patterns.md`.
