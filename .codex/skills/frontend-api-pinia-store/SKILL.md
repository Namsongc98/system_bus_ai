...
1. Read `.codex/references/frontend/pinia-store.md` for store patterns.
2. Read `.codex/references/frontend/rules/clean-code.md` before refactoring existing store logic.
3. Read `.codex/references/frontend/rules/api-service-rules.md` when the store calls or wraps an API service.
