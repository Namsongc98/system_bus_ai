...
1. Read `.codex/references/frontend/frontend-instructions.md` if project hierarchy details are needed.
2. Read `.codex/references/frontend/rules/clean-code.md` and `.codex/references/frontend/rules/rule-component.md` for coding rules and component creation / update rules.
3. Read `.codex/references/frontend/component-reuse-patterns.md` for Pattern A/B, props/emits, slots, and placement guidance.
4. Read `.codex/references/frontend/component-registry.md` for the current reusable component inventory, then inspect actual component files before using them.
