...
Use this skill when the user provides API documentation, endpoint specs, request/response schemas, or asks Codex to generate services from `.codex/references/frontend/api-document.md`.

## Workflow

1. Read `.codex/references/frontend/rules/api-service-rules.md` for mandatory service-layer rules.
2. Read `.codex/references/frontend/api-document.md` or the user-provided API documentation.
3. Determine the endpoint type:
   - JSON response: follow `.codex/references/frontend/api-json-service.md`.
   - Blob/download response: follow `.codex/references/frontend/api-download-service.md`.
   - Error behavior unclear: check `.codex/references/frontend/api-error-handling.md`.
