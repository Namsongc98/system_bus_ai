...
2. Read `.codex/references/frontend/api-download-service.md` for download implementation examples.
3. Read `.codex/references/frontend/api-document.md` when endpoint details must come from the project API docs.
