...
1. Read `.codex/references/frontend/frontend-instructions.md` for project conventions.
2. Read `.codex/references/frontend/rules/clean-code.md` for general quality checks.
3. Read `.codex/references/frontend/rules/rule-component.md` when reusable components are involved.
4. Read `.codex/references/frontend/rules/figma-style-rules.md` when reviewing Figma-derived UI or Tailwind-heavy changes.
